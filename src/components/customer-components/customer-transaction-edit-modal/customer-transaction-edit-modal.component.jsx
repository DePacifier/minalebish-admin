...
import "./customer-transaction-edit-modal.styles.scss";

export default class CustomerTransactionEditModal extends Component {
  state = {
    showEdit: false,
    noteData: "",
    itemsDataList: [
  ...
  render() {
    ...
    return (
      <div
        className="customer-transaction-edit-modal"
